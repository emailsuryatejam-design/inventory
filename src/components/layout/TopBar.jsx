...
const BREADCRUMBS = {
  ...
  '/app/payroll': ['Payroll & HR', 'Dashboard'],
  '/app/departments': ['Payroll & HR', 'Departments'],
  '/app/job-grades': ['Payroll & HR', 'Job Grades'],
  '/app/hr-employees': ['Payroll & HR', 'Employees'],
  '/app/hr-employees/new': ['Payroll & HR', 'Employees', 'New'],
  '/app/payroll-periods': ['Payroll & HR', 'Payroll Periods'],
  '/app/payroll-runs': ['Payroll & HR', 'Payroll Runs'],
  '/app/payroll-runs/new': ['Payroll & HR', 'Payroll Runs', 'New'],
  '/app/leave': ['Payroll & HR', 'Leave'],
  '/app/attendance': ['Payroll & HR', 'Attendance'],
  '/app/hr-loans': ['Payroll & HR', 'Loans'],
  '/app/salary-advances': ['Payroll & HR', 'Salary Advances'],
  '/app/expense-claims': ['Payroll & HR', 'Expense Claims'],
  '/app/payroll-reports': ['Payroll & HR', 'Reports'],
  '/app/shifts': ['Payroll & HR', 'Shifts'],
  '/app/hr-regions': ['Payroll & HR', 'Regions'],
  '/app/field-tracking': ['Payroll & HR', 'Field Tracking'],
  '/app/contracts': ['Payroll & HR', 'Contracts'],
  '/app/approvals': ['Payroll & HR', 'Approvals'],
  '/app/payroll-audit': ['Payroll & HR', 'Audit Log'],
  '/app/id-cards': ['Payroll & HR', 'ID Cards'],
  '/app/intro-letters': ['Payroll & HR', 'Intro Letters'],
  '/app/payslip-templates': ['Payroll & HR', 'Payslip Templates'],
}
